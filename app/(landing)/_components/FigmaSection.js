              ...
              <div className="flex flex-col items-center gap-6 mb-8">
                <div className="flex justify-center gap-4 sm:gap-6">
                  ...
                  <a
                    ...
                    className="flex items-center bg-black rounded justify-center w-10 h-10 sm:w-12 sm:h-12 transform rotate-[-5deg] transition-transform duration-200 hover:rotate-0 hover:scale-110"
                  >
                    <svg width="20" height="20" className="sm:w-6 sm:h-6" viewBox="0 0 26 27" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <a
                    ...
                    className="flex items-center bg-black rounded justify-center w-10 h-10 sm:w-12 sm:h-12 transform rotate-[-5deg] transition-transform duration-200 hover:rotate-0 hover:scale-110"
                  >
                    <svg width="20" height="20" className="sm:w-6 sm:h-6" viewBox="0 0 30 29" fill="none" xmlns="http://www.w3.org/2000/svg">
