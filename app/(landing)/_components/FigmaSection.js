...
const FigmaSection = () => {
  return (
    <div className="w-full h-screen relative overflow-hidden bg-white flex justify-center items-center">
      {/* Radial Sunray Background */}
      <div className="flex justify-center items-center w-[2400px] h-[2400px] flex-shrink-0 absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="rays-svg-fill">
          <svg 
            id="61:263" 
            width="2400" 
            height="1982" 
            ...
            className="rays-svg w-[2400px] h-[1981px] flex-shrink-0 absolute left-0 top-[209px]"
          >
          ...
          <img 
            ...
            alt=""
            className="w-[423px] h-[423px] flex-shrink-0 aspect-square absolute left-[987px] top-[866px]"
          />
        </div>
      </div>

      {/* YOUR FAVORITE INTERNET CAT! Text */}
      <div 
        className="flex w-[486px] h-[41px] flex-col justify-center flex-shrink-0 text-black font-inter text-[27px] font-bold leading-[40.5px] text-center whitespace-nowrap absolute left-[717px] top-[816px]"
        style={{
      ...
      {/* BUY NOW Button */}
      <div className="flex w-[195px] h-[68px] transform rotate-[-4deg] px-[27.864px] py-[19.332px] pb-[18.665px] pl-[28.561px] justify-center items-center flex-shrink-0 border-4 border-black bg-[#ED2B20] shadow-[0_1px_3px_0_rgba(0,0,0,0.10),0_1px_2px_-1px_rgba(0,0,0,0.10)] absolute left-[860px] top-[890px]">
        <div 
          className="flex w-[139px] h-[30px] flex-col justify-center flex-shrink-0 text-white text-center font-luckiest-guy text-[30px] font-normal leading-[36px] tracking-[0.75px] absolute left-[30px] top-[21px]"
          style={{
      ...
      <img 
        ...
        alt=""
        className="w-[44px] h-[44px] transform rotate-[5deg] flex-shrink-0 absolute left-[54px] top-[1091px]"
      />

      {/* Instagram Icon */}
      <img 
        src="https://api.builder.io/api/v1/image/assets/TEMP/bc70d527725939d9e5c869b173d26405edc85d3e?width=88"
        alt=""
        className="w-[44px] h-[44px] transform rotate-[-5deg] flex-shrink-0 absolute left-[114px] top-[1091px]"
      />

      {/* Instagram SVG Icon */}
      <div className="flex w-[44px] h-[44px] transform rotate-[5deg] justify-center items-center flex-shrink-0 bg-black absolute left-[174px] top-[1091px]">
        <div className="flex w-[44px] h-[44px] p-[10px] justify-center items-center flex-shrink-0 absolute left-0 top-0">
          <svg 
            id="61:313"
            width="26" 
            height="27" 
            ...
            fill="none" 
            xmlns="http://www.w3.org/2000/svg"
            className="w-[24px] h-[24px] flex-shrink-0 absolute left-[11px] top-[11px]"
          >
      ...
      {/* TikTok Icon */}
      <div className="flex w-[44px] h-[44px] transform rotate-[-5deg] justify-center items-center flex-shrink-0 bg-black absolute left-[234px] top-[1091px]">
        <div className="flex w-[44px] h-[44px] p-[9px] justify-center items-center flex-shrink-0 absolute left-0 top-0">
          <svg 
            id="61:317"
            width="30" 
            height="29" 
            ...
            fill="none" 
            xmlns="http://www.w3.org/2000/svg"
            className="w-[26px] h-[26px] flex-shrink-0 absolute left-[10px] top-[10px]"
          >
