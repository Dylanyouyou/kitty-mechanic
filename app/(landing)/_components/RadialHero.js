...
const RadialHero = () => {
  return (
    <section className="relative w-full min-h-screen flex flex-col bg-red-600 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 items-center min-h-[60vh]">
            ...
            <div className="flex lg:flex-col flex-row justify-center lg:justify-start items-center gap-4 lg:gap-6 order-3 lg:order-1">
              ...
              <a
                ...
                className="w-12 h-12 sm:w-14 sm:h-14 bg-black hover:bg-gray-800 transition-colors rounded transform rotate-[5deg] hover:rotate-0 hover:scale-110 transition-transform duration-200 flex items-center justify-center"
              >
                <img
            ...
            <div className="flex flex-col items-center justify-center text-center order-1 lg:order-2">
              ...
              <div className="mb-6 sm:mb-8">
                <h2 className="text-2xl sm:text-3xl lg:text-[30px] font-normal text-black font-inter leading-[36px] pb-4">
