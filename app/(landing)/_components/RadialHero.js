...
const RadialHero = () => {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-red-600">
      {/* Radial Sunray Background */}
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-[150vmax] h-[150vmax] max-w-[2400px] max-h-[2400px]">
          <svg
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-black font-inter mb-4">
        ...
        <div className="mb-12 sm:mb-16">
          <button
            className="transform rotate-[-4deg] hover:rotate-0 transition-transform duration-200 px-6 py-4 sm:px-8 sm:py-5 bg-red-600 border-4 border-black text-white font-luckiest-guy text-xl sm:text-2xl lg:text-3xl tracking-wider shadow-[4px_4px_0_0_#000] hover:shadow-[6px_6px_0_0_#000] hover:translate-y-[-2px] transition-all"
        ...
        <div className="flex gap-3 sm:gap-4">
          ...
          <a
            ...
            className="w-11 h-11 sm:w-12 sm:h-12 bg-black hover:bg-gray-800 transition-colors rounded transform rotate-[5deg] hover:rotate-0 hover:scale-110 transition-transform duration-200 flex items-center justify-center"
          >
            <img
